...
#define MyColor [LJUtil hexStringToColor:@"#5A567C"] //主题色
#define MyFontColor [UIColor whiteColor]
#define FontColor [LJUtil hexStringToColor:@"#333333"]//深灰色字体
#define LightGrayFontColor [UIColor lightGrayColor] //灰色字体
#define ProgressColor [LJUtil hexStringToColor:@"#A0CB90"] //深灰色字体

#define PlaceholderImage [UIImage imageNamed:@"zhanwei"]//占位图
